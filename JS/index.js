...
const reviewItems = [
  {
    reviewText:
      "These guys are on Point! Straight forward, honest and upfront about the circumstances. Helpful across the board and went out of his way to help us out during our emergency. Easiest business I'done in a long time. 5 stars and then some :) THANK YOU!",
    author: 'Reef D.',
    company: '',
  },
  {
    reviewText:
      'Great experience, extremely professional! Highly recommend Wolf Brothers!',
    author: 'Ben M.',
    company: '',
  },
  {
    reviewText:
      'This guy is fantastic. Comes in and does a great job everytime. We have used him several times.',
    author: 'Justice S.',
    company: '',
  },
  // {
...
const enlargeExamples = (buttonList, cardData) => {
  for (const button of buttonList) {
    button.addEventListener('click', () => {
      ...
      const matchedTestimonialCard = cardData.find(
